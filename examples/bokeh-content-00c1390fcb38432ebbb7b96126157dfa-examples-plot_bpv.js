(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("844105e7-60a9-4415-919d-b3ab027e4e57");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '844105e7-60a9-4415-919d-b3ab027e4e57' but no matching script tag was found.")
        }
